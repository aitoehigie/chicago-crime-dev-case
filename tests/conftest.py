...
# WARNING: Ensure imports from `chicago_crime_dev_case` comes after this line
from chicago_crime_dev_case import app, settings, db  # noqa
from chicago_crime_dev_case.cli import create_user, cli  # noqa
