...
description = """
chicago_crime_dev_case API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="chicago_crime_dev_case",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://chicago_crime_dev_case.com/terms/",
    contact={
        "name": "aitoehigie",
        "url": "http://chicago_crime_dev_case.com/contact/",
        "email": "aitoehigie@chicago_crime_dev_case.com",
    },
    license_info={
        "name": "The Unlicense",
